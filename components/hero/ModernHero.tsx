...
const REFERENCE_DATA = [
  {
    ...
    title2: "& HARMONY",
    description:
      "Deep compatibility analysis using composite charts and planetary overlays to understand relationship dynamics. Discover the cosmic connection.",
    image: "/slide4.png",
  },
  {
    place: "CAREER",
    ...
    title2: "PATH",
    description:
      "Align your career choices with your astrological strengths. Identify periods of growth, professional opportunities, and your true calling.",
    image: "/slide5.png",
  },
  {
    place: "TIMING",
